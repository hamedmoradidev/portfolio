...
export default function Home() {
  return (
    <>
        <div id='home' className='bg-project-light-gray-home h-lvh text-project-black-first flex justify-start flex-wrap items-center relative overflow-hidden'>
        ...
        <img className='lg:hidden z-20 h-4/5 absolute bottom-0 right-0' src={me2} alt="" />
        </div>
    </>
  )
}
